...
public class MainView extends View {
    ...
    private void drawCellText(Canvas canvas, int value, int sX, int sY) {
        ...
        canvas.drawText(value==2?MainGame.TILE_TITLE_O:MainGame.TILE_TITLE_X, sX + cellSize / 2, sY + cellSize / 2 - textShiftY, paint);
    }
    ...
    private void drawBackgroundGrid(Canvas canvas) {
        cellField = new Cell[game.numSquaresX][game.numSquaresY];
        ...
        for (int xx = 0; xx < game.numSquaresX; xx++) {
            for (int yy = 0; yy < game.numSquaresY; yy++) {
                ...
                int eY = sY + cellSize;
                cellField[yy][xx]  = new Cell(yy,xx,sX,sY,eX,eY);
    ...
    private void createBitmapCells() {
        ...
        for (int xx = 1; xx < bitmapCell.length; xx++) {
            ...
            float tempTextSize = cellTextSize * cellSize * 1.5f / Math.max(cellSize * 0.9f, paint.measureText(String.valueOf(value)));
    ...
    private void getLayout(int width, int height) {
        ...
        instructionsTextSize = (int) (textSize / 2);
        headerTextSize = (int)(textSize * 1.5);
        gameOverTextSize = (int)(textSize * 1.5);
    ...
    public MainView(Context context) {
        ...
        setOnTouchListener(new TouchInputListener(this));
        game.newGame();
    }
