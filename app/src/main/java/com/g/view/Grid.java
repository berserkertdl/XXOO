        ...
        for (int xx = 0; xx < bufferField.length; xx++) {
            for (int yy = 0; yy < bufferField[0].length; yy++) {
                if (bufferField[xx][yy] == null) {
                    ...
                    undoField[xx][yy] = new Tile(xx, yy,bufferField[xx][yy].getValue(), bufferField[xx][yy].getTitle());
                }
            }
        }
    }
        ...
        for (int xx = 0; xx < field.length; xx++) {
            for (int yy = 0; yy < field[0].length; yy++) {
                if (field[xx][yy] == null) {
                    ...
                    bufferField[xx][yy] = new Tile(xx, yy,field[xx][yy].getValue(), field[xx][yy].getTitle());
                }
            }
        }
    }
        ...
        for (int xx = 0; xx < undoField.length; xx++) {
            for (int yy = 0; yy < undoField[0].length; yy++) {
                if (undoField[xx][yy] == null) {
                    ...
                    field[xx][yy] = new Tile(xx, yy,undoField[xx][yy].getValue(), undoField[xx][yy].getTitle());
                }
            }
        }
    }
